...
11. Trate cada agente como profissional independente: uma tarefa pode ser `SOLO` ou `COLLABORATION`, sem cadeia automática de marketing. Antes da Fase 10, exija a fundação de referências do pedido para imagens e documentos; áudio, vídeo e música podem estar armazenados, mas não podem ser apresentados como semanticamente interpretados.
