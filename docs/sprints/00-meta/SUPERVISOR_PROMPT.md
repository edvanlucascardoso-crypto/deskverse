...
11. Trate cada agente como profissional independente: uma tarefa pode ser `SOLO` ou `COLLABORATION`, sem cadeia automática de marketing. Antes da Fase 10, exija a fundação de referências do pedido para imagens e documentos; áudio, vídeo e música podem estar armazenados, mas não podem ser apresentados como semanticamente interpretados. A SPRINT-15-20 pode analisar tecnicamente e masterizar áudio por uma tool/MCP privada derivada de open source auditado, sem transformar isso em compreensão semântica de música.
