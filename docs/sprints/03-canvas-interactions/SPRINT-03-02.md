# SPRINT-03-02 — Seleção multiseleção e teclado

**Fase:** 03 — Interações do Canvas
**Status:** COMPLETE_WITH_INTEGRATION_REQUIREMENTS
**Dependências:** SPRINT-03-01
**Superfície principal:** seleção simples, múltipla, foco roving e atalhos

## Objetivo

Entregar seleção simples, múltipla, foco roving e atalhos como uma fatia utilizável do workspace. A sprint deve transformar a missão da fase em comportamento observável, com limites claros e sem antecipar responsabilidades de fases posteriores.

## Trabalho

1. Definir o fluxo principal de seleção simples, múltipla, foco roving e atalhos e os estados que o usuário precisa compreender.
