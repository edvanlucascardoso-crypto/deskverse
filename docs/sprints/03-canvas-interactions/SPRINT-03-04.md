# SPRINT-03-04 — Busca filtros e atalhos de contexto

**Fase:** 03 — Interações do Canvas
**Status:** COMPLETE_WITH_INTEGRATION_REQUIREMENTS
**Dependências:** SPRINT-03-03
**Superfície principal:** busca local, filtros combináveis e sheet de contexto

## Objetivo

Entregar busca local, filtros combináveis e atalhos para pendências sem retirar o canvas de tela inteira como superfície dominante. Filtros, atividade e atalhos detalhados devem ficar em sheet/drawer; no canvas, só permanecem controles icon-only essenciais.

## Trabalho

1. Definir o fluxo principal de busca local, filtros combináveis e atalhos para pendências e os estados que o usuário precisa compreender.
