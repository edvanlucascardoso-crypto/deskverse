# SPRINT-04-02 — Estados de trabalho e presença

**Fase:** 04 — Pessoas e Atividade
**Status inicial:** PLANNED
**Dependências:** SPRINT-04-01
**Superfície principal:** disponível, trabalhando, aguardando usuário, bloqueado, pausado e concluído

## Objetivo

Entregar disponível, trabalhando, aguardando usuário, bloqueado, pausado e concluído como uma fatia utilizável do workspace. A sprint deve transformar a missão da fase em comportamento observável, com limites claros e sem antecipar responsabilidades de fases posteriores.

## Trabalho

1. Definir o fluxo principal de disponível, trabalhando, aguardando usuário, bloqueado, pausado e concluído e os estados que o usuário precisa compreender.
