# SPRINT-04-04 — Linha do tempo e central de atualizações

**Fase:** 04 — Pessoas e Atividade
**Status inicial:** PLANNED
**Dependências:** SPRINT-04-03
**Superfície principal:** feed acionável com origem, impacto e item relacionado

## Objetivo

Entregar feed acionável com origem, impacto e item relacionado como uma fatia utilizável do workspace. A sprint deve transformar a missão da fase em comportamento observável, com limites claros e sem antecipar responsabilidades de fases posteriores.

## Trabalho

1. Definir o fluxo principal de feed acionável com origem, impacto e item relacionado e os estados que o usuário precisa compreender.
