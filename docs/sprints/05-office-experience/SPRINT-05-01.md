# SPRINT-05-01 — Estado local do escritório

**Fase:** 05 — Experiência do Escritório
**Status inicial:** PLANNED
**Dependências:** nenhuma
**Superfície principal:** store local, seleção, layout e ciclo de atualização

## Objetivo

Entregar store local, seleção, layout e ciclo de atualização como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de store local, seleção, layout e ciclo de atualização com dados mínimos e estados nomeados.
