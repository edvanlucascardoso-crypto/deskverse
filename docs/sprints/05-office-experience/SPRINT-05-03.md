# SPRINT-05-03 — Simulador de agentes para desenvolvimento

**Fase:** 05 — Experiência do Escritório
**Status inicial:** PLANNED
**Dependências:** SPRINT-05-02
**Superfície principal:** atores simulados, cenários repetíveis e falhas controladas

## Objetivo

Entregar atores simulados, cenários repetíveis e falhas controladas como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de atores simulados, cenários repetíveis e falhas controladas com dados mínimos e estados nomeados.
