# SPRINT-05-04 — Escritório persistente e painéis laterais

**Fase:** 05 — Experiência do Escritório
**Status inicial:** PLANNED
**Dependências:** SPRINT-05-03
**Superfície principal:** persistência apropriada, restauração e painéis de contexto

## Objetivo

Entregar persistência apropriada, restauração e painéis de contexto como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de persistência apropriada, restauração e painéis de contexto com dados mínimos e estados nomeados.
