# SPRINT-05-05 — Loop completo do produto

**Fase:** 05 — Experiência do Escritório
**Status inicial:** PLANNED
**Dependências:** SPRINT-05-04
**Superfície principal:** entrada, trabalho, decisão humana, entrega e retorno ao canvas

## Objetivo

Entregar entrada, trabalho, decisão humana, entrega e retorno ao canvas como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de entrada, trabalho, decisão humana, entrega e retorno ao canvas com dados mínimos e estados nomeados.
