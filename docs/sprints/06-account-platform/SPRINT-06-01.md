# SPRINT-06-01 — Estrutura final da aplicação e limites de responsabilidade

**Fase:** 06 — Conta e Plataforma
**Status inicial:** PLANNED
**Dependências:** nenhuma
**Superfície principal:** limites entre interface, domínio, persistência e serviços

## Objetivo

Entregar limites entre interface, domínio, persistência e serviços como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de limites entre interface, domínio, persistência e serviços com dados mínimos e estados nomeados.
