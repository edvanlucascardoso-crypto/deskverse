# SPRINT-06-02 — Banco de dados multi-tenant

**Fase:** 06 — Conta e Plataforma
**Status inicial:** PLANNED
**Dependências:** SPRINT-06-01
**Superfície principal:** persistência isolada para organizações, workspaces e itens

## Objetivo

Entregar persistência isolada para organizações, workspaces e itens como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de persistência isolada para organizações, workspaces e itens com dados mínimos e estados nomeados.
