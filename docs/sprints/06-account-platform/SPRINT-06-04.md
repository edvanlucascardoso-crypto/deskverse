# SPRINT-06-04 — Organizações workspaces e membros

**Fase:** 06 — Conta e Plataforma
**Status inicial:** PLANNED
**Dependências:** SPRINT-06-03
**Superfície principal:** criação, seleção e associação de pessoas

## Objetivo

Entregar criação, seleção e associação de pessoas como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de criação, seleção e associação de pessoas com dados mínimos e estados nomeados.
