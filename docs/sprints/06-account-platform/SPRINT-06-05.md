# SPRINT-06-05 — Permissões por função

**Fase:** 06 — Conta e Plataforma
**Status inicial:** PLANNED
**Dependências:** SPRINT-06-04
**Superfície principal:** papéis, ações permitidas e negativa segura

## Objetivo

Entregar papéis, ações permitidas e negativa segura como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de papéis, ações permitidas e negativa segura com dados mínimos e estados nomeados.
