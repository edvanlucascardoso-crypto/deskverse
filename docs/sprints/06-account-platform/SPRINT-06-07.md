# SPRINT-06-07 — Shell autenticado e navegação

**Fase:** 06 — Conta e Plataforma
**Status inicial:** PLANNED
**Dependências:** SPRINT-06-06
**Superfície principal:** rotas protegidas, contexto ativo e retorno ao workspace

## Objetivo

Entregar rotas protegidas, contexto ativo e retorno ao workspace como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de rotas protegidas, contexto ativo e retorno ao workspace com dados mínimos e estados nomeados.
