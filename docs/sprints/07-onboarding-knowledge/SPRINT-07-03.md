...
**Dependências:** SPRINT-07-02
**Superfície principal:** perguntas, progresso, retomada e primeiro resumo

## Objetivo

Entregar perguntas, progresso, retomada e primeiro resumo como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de perguntas, progresso, retomada e primeiro resumo com dados mínimos e estados nomeados.
