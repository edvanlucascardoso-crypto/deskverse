...
**Dependências:** SPRINT-07-05
**Superfície principal:** fontes conflitantes, confiança, revisão e validade

## Objetivo

Entregar fontes conflitantes, confiança, revisão e validade como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de fontes conflitantes, confiança, revisão e validade com dados mínimos e estados nomeados.
