...
**Dependências:** SPRINT-07-06
**Superfície principal:** BrandProfile, fatos verificados, tom e readiness

## Objetivo

Entregar BrandProfile, fatos verificados, tom e readiness como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de BrandProfile, fatos verificados, tom e readiness com dados mínimos e estados nomeados.
