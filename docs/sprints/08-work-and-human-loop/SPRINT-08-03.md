# SPRINT-08-03 — Central de entregas no canvas

**Fase:** 08 — Trabalho e Loop Humano
**Status inicial:** PLANNED
**Dependências:** SPRINT-08-02
**Superfície principal:** entregas, revisão e histórico no workspace

## Objetivo

Entregar entregas, revisão e histórico no workspace como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de entregas, revisão e histórico no workspace com dados mínimos e estados nomeados.
...
- A central de entregas abre a partir do canvas e retorna ao card de origem.
- A pessoa vê pendentes, aprovadas, mudanças solicitadas e rejeitadas.
- A entrega só muda de estado por uma ação explícita.
