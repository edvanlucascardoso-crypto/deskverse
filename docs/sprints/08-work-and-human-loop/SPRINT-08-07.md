# SPRINT-08-07 — Revisão e aprovação humana

**Fase:** 08 — Trabalho e Loop Humano
**Status inicial:** PLANNED
**Dependências:** SPRINT-08-06
**Superfície principal:** aprovar, solicitar mudança, rejeitar, pausar e retomar

## Objetivo

Entregar aprovar, solicitar mudança, rejeitar, pausar e retomar como uma fatia utilizável do produto. A implementação deve ligar o comportamento à experiência do workspace, deixando explícitos os estados que o usuário pode observar e as decisões que pertencem a outra fase.

## Trabalho

1. Modelar o caminho principal de aprovar, solicitar mudança, rejeitar, pausar e retomar com dados mínimos e estados nomeados.
