# SPRINT-11-05 — Conexões atribuições e inbox unificada

**Fase:** 11 — Integrações e Planejamento
**Status inicial:** PLANNED
**Dependências:** SPRINT-11-04
**Superfície principal:** canais, responsáveis e pendências em um só lugar

## Objetivo

Entregar canais, responsáveis e pendências em um só lugar como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de canais, responsáveis e pendências em um só lugar.
