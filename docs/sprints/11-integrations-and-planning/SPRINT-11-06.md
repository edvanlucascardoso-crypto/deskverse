# SPRINT-11-06 — Agenda de publicações

**Fase:** 11 — Integrações e Planejamento
**Status inicial:** PLANNED
**Dependências:** SPRINT-11-05
**Superfície principal:** calendário, fuso, aprovação e replanejamento

## Objetivo

Entregar calendário, fuso, aprovação e replanejamento como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de calendário, fuso, aprovação e replanejamento.
