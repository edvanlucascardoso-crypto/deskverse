# SPRINT-12-02 — Planos limites e período de teste

**Fase:** 12 — Cobrança e Uso
**Status inicial:** PLANNED
**Dependências:** SPRINT-12-01
**Superfície principal:** entitlements, limites, trial e comunicação

## Objetivo

Entregar entitlements, limites, trial e comunicação como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de entitlements, limites, trial e comunicação.
