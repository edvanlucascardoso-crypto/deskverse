# SPRINT-12-03 — Add-ons de workspace

**Fase:** 12 — Cobrança e Uso
**Status inicial:** PLANNED
**Dependências:** SPRINT-12-02
**Superfície principal:** extras, ativação, remoção e impacto

## Objetivo

Entregar extras, ativação, remoção e impacto como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de extras, ativação, remoção e impacto.
