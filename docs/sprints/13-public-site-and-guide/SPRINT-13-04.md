# SPRINT-13-04 — SEO analytics e conversão

**Fase:** 13 — Site Público e Guia
**Status inicial:** PLANNED
**Dependências:** SPRINT-13-03
**Superfície principal:** metadados, eventos, consentimento e funil

## Objetivo

Entregar metadados, eventos, consentimento e funil como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de metadados, eventos, consentimento e funil.
