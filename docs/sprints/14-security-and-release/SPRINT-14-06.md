# SPRINT-14-06 — Testes ponta a ponta do produto

**Fase:** 14 — Segurança e Release
**Status inicial:** PLANNED
**Dependências:** SPRINT-14-05
**Superfície principal:** onboarding, agentes, aprovação e entrega

## Objetivo

Entregar onboarding, agentes, aprovação e entrega como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de onboarding, agentes, aprovação e entrega.
