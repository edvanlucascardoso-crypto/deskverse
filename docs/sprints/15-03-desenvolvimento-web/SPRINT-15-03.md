# SPRINT-15-03 — Agente futuro de desenvolvimento web

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fase 09, contratos de workspace/código e segurança de execução; não depende de `SPRINT-15-02`.
**Superfície principal:** escopo, implementação e preview

**Documentação:** [README](README.md) · [PRD](PRD-15-03-DESENVOLVIMENTO-WEB.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar escopo, implementação e preview como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de escopo, implementação e preview.
