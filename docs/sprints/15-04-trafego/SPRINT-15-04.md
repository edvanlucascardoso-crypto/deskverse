# SPRINT-15-04 — Agente futuro de tráfego

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 09 e 11, conexões de canais e métricas autorizadas; não depende de `SPRINT-15-03`.
**Superfície principal:** campanhas, orçamento e otimização

**Documentação:** [README](README.md) · [PRD](PRD-15-04-TRAFEGO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar campanhas, orçamento e otimização como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de campanhas, orçamento e otimização.
