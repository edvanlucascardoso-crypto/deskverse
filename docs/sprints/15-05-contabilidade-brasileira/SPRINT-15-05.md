...
**Dependências:** Fases 09 e 14, assets/documentos autorizados e revisão fiscal/jurídica; não depende de `SPRINT-15-04`.
**Superfície principal:** classificação, documentos e ressalvas

**Documentação:** [README](README.md) · [PRD](PRD-15-05-CONTABILIDADE-BR.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
