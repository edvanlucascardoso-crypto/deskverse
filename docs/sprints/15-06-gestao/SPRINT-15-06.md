# SPRINT-15-06 — Agente futuro de gestão

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 08 e 09, dados de projetos e decisões autorizados; não depende de `SPRINT-15-05`.
**Superfície principal:** prioridades, capacidade e decisões

**Documentação:** [README](README.md) · [PRD](PRD-15-06-GESTAO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar prioridades, capacidade e decisões como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de prioridades, capacidade e decisões.
