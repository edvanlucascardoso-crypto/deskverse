# SPRINT-15-07 — Agente futuro de pré-vendas

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 09 e 11, núcleo de canais e consentimento; não depende de `SPRINT-15-06`.
**Superfície principal:** qualificação, contexto e handoff

**Documentação:** [README](README.md) · [PRD](PRD-15-07-PRE-VENDAS.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar qualificação, contexto e handoff como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de qualificação, contexto e handoff.
