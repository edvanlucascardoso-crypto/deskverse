# SPRINT-15-09 — Agente futuro de pós-vendas

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 08, 09 e 11, eventos de conta e núcleo de mensagens; não depende de `SPRINT-15-08`.
**Superfície principal:** adoção, risco e expansão

**Documentação:** [README](README.md) · [PRD](PRD-15-09-POS-VENDAS.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar adoção, risco e expansão como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de adoção, risco e expansão.
