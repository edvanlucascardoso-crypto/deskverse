# SPRINT-15-10 — Agente futuro de atendimento

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 08, 09 e 11, conhecimento e núcleo de mensagens; não depende de `SPRINT-15-09`.
**Superfície principal:** triagem, resposta e escalonamento

**Documentação:** [README](README.md) · [PRD](PRD-15-10-ATENDIMENTO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar triagem, resposta e escalonamento como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de triagem, resposta e escalonamento.
