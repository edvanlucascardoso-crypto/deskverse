...
**Dependências:** Fases 08 e 09, projeto/tarefa canônicos e autorização de planejamento; não depende de `SPRINT-15-10`.
**Superfície principal:** tela dedicada de projetos, plano, dependências e saúde

**Documentação:** [README](README.md) · [PRD](PRD-15-11-GESTAO-DE-PROJETOS.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
