# SPRINT-15-15 — Agente futuro de dados e BI

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 09 e 11, catálogo de dados e permissões; não depende de `SPRINT-15-14`.
**Superfície principal:** métricas, consultas e explicabilidade

**Documentação:** [README](README.md) · [PRD](PRD-15-15-DADOS-E-BI.md) · [integrações](INTEGRATION_REQUIREMENTS.md)


## Inference profile default

**Primary:** Qwen 3.5 Plus  \
**Escalation:** Gemini 3.1 Pro  \
...
Entregar métricas, consultas e explicabilidade como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de métricas, consultas e explicabilidade.
...
Relatórios, exports, consultas salvas, tabelas e demais artefatos produzidos pelo agente devem ser enviados ao UploadThing por tool, vinculados ao projeto, consulta, versão, origem e agente responsável. A tela de arquivos deve exibir descrição/copy, tipo, data, status e versão na tabela desktop ou na lista de cards mobile, somente para consulta do usuário.
...
- Relatórios e exports aparecem na tela de arquivos após upload confirmado, sem alteração manual ou CRUD para o usuário.
