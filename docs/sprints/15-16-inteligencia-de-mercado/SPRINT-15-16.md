# SPRINT-15-16 — Agente futuro de inteligência de mercado

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 09 e 11, política de pesquisa e fontes autorizadas; não depende de `SPRINT-15-15`.
**Superfície principal:** fontes, síntese e incerteza

**Documentação:** [README](README.md) · [PRD](PRD-15-16-INTELIGENCIA-DE-MERCADO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
...
Entregar fontes, síntese e incerteza como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de fontes, síntese e incerteza.
...
Sínteses, relatórios, anexos, exports e demais artefatos de inteligência produzidos pelo agente devem ser enviados ao UploadThing por tool, vinculados ao projeto, fonte, versão, origem e agente responsável. A tela de arquivos deve mostrar descrição/copy, tipo, data, status, fontes e versão na Data Table paginada com busca ou na lista de cards mobile, sem fornecer edição ao usuário.
...
- As sínteses e os relatórios produzidos aparecem na tela de arquivos após upload confirmado, sem upload manual ou controles de CRUD para o usuário.
