# SPRINT-15-17 — Presença de observadores humanos

**Fase:** 15 — Agentes Futuros
**Status inicial:** PLANNED
**Dependências:** Fases 08 e 09, notificações, approval e takeover; não depende de `SPRINT-15-16`.
**Superfície principal:** papéis humanos, supervisão e takeover

**Documentação:** [README](README.md) · [PRD](PRD-15-17-OBSERVADOR-HUMANO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)


## Inference profile default

**Primary:** nenhum LLM obrigatório. O observador humano não deve consumir inferência apenas para manter presença no canvas.
## Objetivo

Entregar papéis humanos, supervisão e takeover como uma fatia de produto demonstrável. A sprint deve resolver o problema descrito sem antecipar implementação de sprints posteriores e sem esconder decisões de integração.

## Trabalho

1. Descrever e implementar o caminho principal de papéis humanos, supervisão e takeover.
