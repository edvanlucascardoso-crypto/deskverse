...
**Status:** PLANNED  
**Dependências:** Fase 09, especialistas compartilhados e policy de workforce; observação humana é integração recomendada, não dependência de `SPRINT-15-17`.
**Superfície principal:** organizações maiores no mesmo canvas

**Documentação:** [README](README.md) · [PRD](PRD-15-18-LIDERANCA-MULTI-GRUPO.md) · [integrações](INTEGRATION_REQUIREMENTS.md)
