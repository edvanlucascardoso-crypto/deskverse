...
O serviço de vídeo headless é privado no Northflank. API/MCP, workers CPU/GPU e Redis ficam atrás de `WorkerExecutionProvider`, com estado e auditoria no PostgreSQL. FFmpeg executa o pipeline de mídia.
