...
+
# SPRINT-02-02 — Modelagem Blender — arquitetura e workstations essenciais
...
## OBJECTIVE
Modelar o subconjunto essencial de arquitetura + workstations com Blender MCP, seguindo a Art Bible e o inventário mestre.
...
## REQUIREMENTS
- Modelar apenas IDs 1–20 do inventário mestre abaixo.
- Criar materiais/texturas no próprio Blender quando necessárias; preferir materiais simples sem imagem.
- Pivôs coerentes com footprint.
- Exportar cada asset em GLB isolado ou bundle racional.
- Luna xhigh deve iterar por screenshots/renders e corrigir proporções contra o conceito aprovado.

## ALLOWED CHANGES
- assets/3d/architecture/**
- assets/3d/workstations/**
- tools/blender/sources/workstations/**
