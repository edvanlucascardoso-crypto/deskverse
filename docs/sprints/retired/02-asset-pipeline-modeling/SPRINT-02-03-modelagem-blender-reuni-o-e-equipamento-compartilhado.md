...
+
# SPRINT-02-03 — Modelagem Blender — reunião e equipamento compartilhado
...
## OBJECTIVE
Modelar o subconjunto essencial de colaboração + equipamento compartilhado.
...
## REQUIREMENTS
- Modelar apenas IDs 21–32 do inventário mestre.
- Manter silhueta legível em câmera ortográfica.
- Sem telas/reflexos dinâmicos.
- Interaction points de cadeira/mesa ficam em metadata.

## ALLOWED CHANGES
- assets/3d/meeting/**
- assets/3d/shared-equipment/**
- tools/blender/sources/meeting/**
...
- Registre a lacuna em `integration-requirements/SPRINT-02-03-<slug>.json`.
