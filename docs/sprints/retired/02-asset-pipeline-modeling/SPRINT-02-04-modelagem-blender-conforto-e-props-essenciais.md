...
+
# SPRINT-02-04 — Modelagem Blender — conforto e props essenciais
...
## OBJECTIVE
Modelar apenas os props essenciais de conforto/identidade para evitar salas vazias sem inflar o bundle.
...
## REQUIREMENTS
- Modelar IDs 33–40 do inventário mestre.
- Não criar props extras.
- Usar materiais simples e reutilizáveis.
- Wall frame deve ser genérico, sem IP de terceiros.

## ALLOWED CHANGES
- assets/3d/common/**
- tools/blender/sources/common/**
...
- Registre a lacuna em `integration-requirements/SPRINT-02-04-<slug>.json`.
