...
+
# SPRINT-02-06 — Animações essenciais do rig
...
## OBJECTIVE
Produzir somente as animações essenciais do MVP no rig compartilhado.
...
## REQUIREMENTS
- Criar IDs 57–61: idle, walk, sit, talk, work_keyboard.
- Loops limpos onde aplicável.
- Sit precisa alinhar com chair interaction point por contrato.
- Evitar animação facial complexa.

## ALLOWED CHANGES
- assets/3d/characters/animations/**
...
- Hard prerequisites (all must be COMPLETE or accepted by the Supervisor): `SPRINT-02-01`, `SPRINT-02-05`.
...
- Registre a lacuna em `integration-requirements/SPRINT-02-06-<slug>.json`.
- Se um contrato compartilhado parecer inadequado, gere um Contract Change Request; não altere unilateralmente.

## REQUIRED OUTPUTS
- animation clips
- rigged GLB
- animation naming manifest

## ACCEPTANCE / TESTS
- loops
- no root drift indevido
- AnimationMixer carrega clips
