...
+
# SPRINT-02-08 — Catálogo runtime dos assets essenciais
...
- **Why this tier:** Tarefa majoritariamente mecânica/isolada; Luna reduz custo e o esforço elevado compensa sem subir de tier.
...
## OBJECTIVE
Registrar todos os assets essenciais em catálogo tipado e demonstrar instanciação sem hardcode de caminhos.
...
## REQUIREMENTS
- Catálogo deve ser data-driven.
- Nenhum objeto da cena busca GLB por string solta.
- Incluir tags/categories e footprints.
- Não alterar os GLBs.

## ALLOWED CHANGES
- packages/office-assets/catalog/**
- apps/web/src/features/office/dev-catalog/**
- packages/deskverse-engine/src/deskverse/dev-catalog/**
...
- Hard prerequisites (all must be COMPLETE or accepted by the Supervisor): `SPRINT-02-01`, `SPRINT-02-07`.
...
- Registre a lacuna em `integration-requirements/SPRINT-02-08-<slug>.json`.
- Se um contrato compartilhado parecer inadequado, gere um Contract Change Request; não altere unilateralmente.

## REQUIRED OUTPUTS
- typed catalog
- generated registry if useful
- catalog test scene

## ACCEPTANCE / TESTS
- all essential asset IDs resolve
- no duplicate IDs
