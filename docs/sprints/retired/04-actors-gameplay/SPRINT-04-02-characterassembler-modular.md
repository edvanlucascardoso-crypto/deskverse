...
## OBJECTIVE
Montar avatares a partir do kit modular GLB e appearance manifest.
...
## REQUIREMENTS
- Compartilhar rig.
- Partes trocáveis e materiais com variações permitidas.
- Fallback appearance.
- Evitar reload duplicado.
- Usar composição/asset pipeline nativos do Stem pelo facade; não criar scene graph ou loader paralelo.

## ALLOWED CHANGES
- packages/deskverse-engine/src/deskverse/actors/assembler/**
- packages/office-actors/appearance/**
...
- Hard prerequisites (all must be COMPLETE or accepted by the Supervisor): `SPRINT-02-05`, `SPRINT-02-08`, `SPRINT-04-00`, `SPRINT-04-01`, `SPRINT-04-11`.
...
- Registre a lacuna em `integration-requirements/SPRINT-04-02-<slug>.json`.
