...
## OBJECTIVE
Mover actor entre células e sincronizar walk/idle sem teleport visual indevido.
...
## REQUIREMENTS
- Receber destino semântico de Behavior/evento de trabalho, nunca de input do jogador.
- Consultar e executar navegação/movimento nativos do Stem pelo adapter `04-04`.
- Orientar personagem durante movimento.
- Abort/replan seguro.
- Movement adapter deve usar Behaviors/runtime Stem; não criar controlador, integrador ou algoritmo paralelo.
- Não implementar teclado, joystick, click-to-move ou outro controle locomotor humano.

## ALLOWED CHANGES
- packages/deskverse-engine/src/deskverse/actors/movement/**
...
- Hard prerequisites (all must be COMPLETE or accepted by the Supervisor): `SPRINT-04-00`, `SPRINT-04-03`, `SPRINT-04-04`, `SPRINT-04-11`.
...
- arrival state
- execução usa movimento/navegação nativos do Stem
- ausência de input locomotor humano e de movement loop paralelo
