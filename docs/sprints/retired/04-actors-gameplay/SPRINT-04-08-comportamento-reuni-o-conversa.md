...
## OBJECTIVE
Representar atores em reunião/conversa sem simular cada tool call.
...
## REQUIREMENTS
- Meeting uses available meeting slots.
- Conversation is abstract visual state.
- Return actors to prior/default state after meeting.
- Implementar a representação visual como Behavior/Lambda do Deskverse Engine.
- Prototipar pela bridge e entregar Behavior/Lambda Deskverse-owned de produção executado pelo Stem; não criar runtime paralelo nem traduzir protótipo automaticamente.

## ALLOWED CHANGES
- packages/deskverse-engine/src/deskverse/behaviors/meeting/**
...
- Registre a lacuna em `integration-requirements/SPRINT-04-08-<slug>.json`.
...
- enter/leave meeting
- cleanup
- Behaviors/Lambdas Deskverse-owned executam no runtime Stem sem sistema paralelo
