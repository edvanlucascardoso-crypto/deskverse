...
import { Bell, Menu, MessageCircle, Plus, Search, WandSparkles } from "lucide-react";
...
export function CanvasNavbar({ query, onQueryChange, agents, onSelectAgent, onOpenMenu, onOpenNotifications, onOpenConversations, onAddLeader, onOpenAnimationTests, notificationActive }: CanvasNavbarProps) {
