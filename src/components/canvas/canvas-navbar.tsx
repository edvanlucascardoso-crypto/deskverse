...
export function CanvasNavbar({ query, onQueryChange, agents, onSelectAgent, onOpenMenu, onOpenNotifications, onOpenConversations, onAddLeader, onOpenAnimationTests, onOpenOfficeControls, notificationActive }: CanvasNavbarProps) {
