...
describe("Vercel AI Gateway Whisper provider", () => {
  it("uses the Gateway transcription model without calling the OpenAI audio endpoint directly", async () => {
    ...
    expect(result).toEqual({ text: "Transcrição do Gateway.", provider: "Vercel AI Gateway", model: whisperModel });
