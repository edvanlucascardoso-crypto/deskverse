...
export function createKnowledgeFixtures(workspaceId: string): KnowledgeFixtureState {
  const documents: KnowledgeDocument[] = [
    ...
    { id: "document-interview", workspaceId, name: "entrevista-inicial.mp3", mimeType: "audio/mpeg", format: "audio", size: 3_840_000, checksum: "sha256:interview", origin: "UploadThing", processingStatus: "WAITING_USER", processingError: "A transcrição aguarda OPENAI_API_KEY.", createdAt: timestamp, updatedAt: timestamp, currentVersion: { id: "interview-v1", documentId: "document-interview", version: 1, checksum: "sha256:interview", processingStatus: "WAITING_USER", conversionTrace: [{ step: "transcribe", status: "waiting_user", provider: "OpenAI Whisper", message: "Configure a chave da OpenAI para continuar.", occurredAt: timestamp }], createdAt: timestamp, updatedAt: timestamp } },
  ];
